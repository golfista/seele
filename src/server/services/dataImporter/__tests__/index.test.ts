...
import {
  ...
  topics,
  users,
} from '@/database/server/schemas/Seele';
          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'Seele is an AI conversation application built with the Next.js framework. I will help you write the development documentation for Seele.',
                tags: [
                ...
                title: 'Seele Technical Documentation Expert',
              },
              type: 'agent',
