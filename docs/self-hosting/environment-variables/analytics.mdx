---
title: Integrating Analytics in Seele
description: >-
  Learn how to configure environment variables for Vercel Analytics, Google
  Analytics, PostHog Analytics, and Umami Analytics in Seele for data
...
We have integrated several free/open-source data analytics services in Seele for collecting user usage data. Here are environment variables that you can use.
