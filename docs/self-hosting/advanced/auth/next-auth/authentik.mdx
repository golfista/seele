---
title: Configuring Authentik Authentication Service for Seele
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for Seele,
  including creating an application provider, setting environment variables, and
  deployment instructions.
tags:
  - Authentik Configuration
  - Single Sign-On (SSO)
  - Seele Authentication
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use Seele by authenticating with the users
