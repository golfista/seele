---
title: Configuring Github Authentication Service for Seele
description: >-
  Learn how to configure Github authentication service for Seele, including
...
| `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for Seele. Use `github` for Github. |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use Seele.
</Callout>
