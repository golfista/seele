---
title: Configure ZITADEL Authentication Service for Seele
description: >-
  Learn how to configure ZITADEL Authentication Service for Seele deployment,
...
- Replace `http(s)://your-domain` with the actual URL that Seele is deployed to.
...
<Callout>
  After successful deployment, users will be able to authenticate and use Seele using existing
