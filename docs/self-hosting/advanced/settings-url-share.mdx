...
description: >-
  Learn how to import and export configuration settings for Seele via URL.
...
Seele support import settings from external URL to quickly set up Seele configuration.
...
<Callout type={'warning'}>
  Seele does not verify the correctness of the settings parameters in the URL, nor provide
