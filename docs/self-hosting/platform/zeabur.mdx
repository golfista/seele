...
# Deploy Seele with Zeabur

If you want to deploy Seele on Zeabur, you can follow the steps below:
...
# Deploy Seele with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy Seele as a serverless function service. To deploy Seele as a serverless function service on Zeabur, you can follow the steps below:
...
### Link your fork of Seele to the just created Zeabur service.
