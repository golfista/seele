---
title: Deploy Seele with Docker Compose
description: >-
  Learn how to deploy the Seele service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the Seele service on your private device.
...
Run the following command to start the Seele service:
...
Similarly, you can use the following script to automatically update Seele. When using `Docker Compose`, no additional configuration of environment variables is required.
