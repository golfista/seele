...
Run the following command to start the LobeChat service:
...
Similarly, you can use the following script to automatically update LobeChat. When using `Docker Compose`, no additional configuration of environment variables is required.
