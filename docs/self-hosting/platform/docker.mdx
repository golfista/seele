---
title: Deploy Seele with Docker
description: >-
  Learn how to deploy the Seele service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the Seele service on your private device.
...
Use the following command to start the Seele service with one click:
...
- For the complete list of environment variables supported by Seele, please refer to the [Environment Variables](/docs/self-hosting/environment-variables) section.
