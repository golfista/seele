---
title: Deploy Seele with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy Seele on Netlify with detailed instructions on forking
...
# Deploy Seele with Netlify

If you want to deploy Seele on Netlify, you can follow these steps:

## Deploy Seele with Netlify

<Steps>
  ### Fork the Seele Repository

Click the Fork button to fork the Seele repository to your GitHub account.
...
Next, select the Seele project:

<Image
  alt={'Select the Seele github project'}
  height={228}
  inStep
...
<Image
  alt={'Add Seele site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by Seele, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your Seele is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'Seele deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your Seele has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your Seele site.

  <Image alt={'Access Your Seele Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
