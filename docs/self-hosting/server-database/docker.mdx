---
title: Deploying Seele Database with Docker
description: >-
  Learn how to deploy the Seele server database version using Docker on Linux
  and local machines.
tags:
  - Seele
  - Docker
...
Here is the process for deploying the Seele server database version on a Linux server:
...
The data version of Seele also supports direct use on a local Mac/Windows machine.
