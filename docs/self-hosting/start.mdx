...
tags:
  ...
  - Docker Compose
---
# Build Your Own LobeChat

LobeChat supports various deployment platforms, including Vercel, Docker, and Docker Compose. You can choose a deployment platform that suits you to build your own LobeChat.
