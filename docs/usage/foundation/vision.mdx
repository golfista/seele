...
description: >-
  Explore how Seele integrates visual recognition capabilities into large
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, Seele now supports various large language models with visual recognition capabilities, enabling Seele to have multimodal interaction capabilities.
