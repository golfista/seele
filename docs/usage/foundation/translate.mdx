---
title: Translation of Conversation Records - Seele
description: >-
  Learn how to translate conversation content in Seele with just one click.
...
Seele supports users to translate conversation content into a specified language with just one click. After selecting the target language, Seele will use a pre-set AI model for translation and display the translated results in real-time in the chat window.
