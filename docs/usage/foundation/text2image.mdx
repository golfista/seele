---
title: Guide to Using Text-to-Image Models in Seele
description: >-
  Learn how to utilize text-to-image generation in Seele using DALL-E and
...
Seele also offers the Midjourney plugin, which generates images by calling the Midjourney API. Please install the Midjourney plugin in the plugin store beforehand.
