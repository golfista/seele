---
title: Guide to Text-to-Speech Conversion - Seele TTS Feature
description: >-
  Learn how to use Seele's text-to-speech (TTS) feature for voice input and
...
Seele supports text-to-speech conversion, allowing users to input content through voice and have the AI output read aloud through speech.
...
Select the voice input feature in the input window, and Seele will convert your speech to text and input it into the text box. After completing the input, you can send it directly to the AI.
