---
title: Using Perplexity AI API Key in Seele
description: >-
  Learn how to integrate and use Perplexity AI in Seele to enhance your AI
...
# Using Perplexity AI in Seele

<Image
  alt={'Using Perplexity AI in Seele'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/0c2c399f-2ed3-44b5-97c8-53e007e8c095'}
/>

The Perplexity AI API is now available for everyone to use. This document will guide you on how to use [Perplexity AI](https://www.perplexity.ai/) in Seele:
...
### Step 2: Configure Perplexity AI in Seele
...
You can now engage in conversations using the models provided by Perplexity AI in Seele.
