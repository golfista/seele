---
title: 在 Seele 中使用智谱 ChatGLM API Key
description: 学习如何在 Seele 中配置和使用智谱AI的 API Key，开始与智谱AI提供的模型进行对话。
tags:
  - 智谱AI
  - ChatGLM
  - API Key
...
至此你已经可以在 Seele 中使用智谱AI提供的模型进行对话了。
