---
title: Using Moonshot AI API Key in Seele
description: >-
  Learn how to integrate Moonshot AI into Seele for AI-powered conversations.
...
# Using Moonshot AI in Seele

<Image
  alt={'Using Moonshot AI in Seele'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/21b94782-875b-4dee-a572-3c5843f3e1e3'}
/>

The Moonshot AI API is now available for everyone to use. This document will guide you on how to use [Moonshot AI](https://www.moonshot.cn/) in Seele:
...
### Step 2: Configure Moonshot AI in Seele
...
You can now engage in conversations using the models provided by Moonshot AI in Seele.
