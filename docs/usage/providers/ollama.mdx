---
title: Using Ollama in Seele
description: >-
  Learn how to use Ollama in Seele, run LLM locally, and experience
...
# Using Ollama in Seele

<Image
  alt={'Using Ollama in Seele'}
  borderless
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/f579b39b-e771-402c-a1d1-620e57a10c75'}
/>

Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, Seele supports integration with Ollama, meaning you can easily enhance your application by using the language models provided by Ollama in Seele.

This document will guide you on how to use Ollama in Seele:

<Video
  alt="demonstration of using Ollama in Seele"
  height={580}
...
### Conversing with Local Large Models in Seele

Now, you can start conversing with the local LLM in Seele.

<Image
  alt="Chat with llama3 in Seele"
  height="573"
...
### Installation in Seele

In Seele, we have enabled some common large language models by default, such as llama3, Gemma, Mistral, etc. When you select a model for conversation, we will prompt you to download that model.

<Image
  alt="Seele guide your to install Ollama model"
  height="460"
...
<Callout type={'info'}>
  ...
  Seele to meet integration needs with Ollama.
</Callout>
