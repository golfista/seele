---
title: Using Together AI in Seele API Key
description: >-
  Learn how to integrate Together AI into Seele, obtain the API key,
...
# Using Together AI in Seele

<Image
  alt={'Using Together AI in Seele'}
  cover
...
This document will guide you on how to use Together AI in Seele:
...
You can now engage in conversations using the models provided by Together AI in Seele.
