---
title: Using OpenRouter API Key in Seele
description: >-
  Learn how to integrate and utilize OpenRouter's language model APIs in
  Seele. Follow these steps to register, create an API key, recharge credit,
...
# Using OpenRouter in Seele

<Image
  alt={'Using OpenRouter in Seele'}
  cover
...
This document will guide you on how to use OpenRouter in Seele:
...
- Name your API key in the pop-up dialog, for example, "Seele Key"
...
### Step 4: Configure OpenRouter in Seele

- Visit the `Settings` interface in Seele
- Find the setting for `OpenRouter` under `Language Models`
- Enable OpenRouter and enter the API key you obtained

<Image
  alt={'Configure OpenRouter in Seele'}
  height={518}
  inStep
...
You can now engage in conversations using the models provided by OpenRouter in Seele.
