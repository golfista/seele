---
title: Using Azure OpenAI API Key in Seele
description: >-
  Learn how to integrate and configure Azure OpenAI in Seele to enhance your
...
# Using Azure OpenAI in Seele

<Image
  alt={'Azure OpenAI in Seele'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'}
/>

This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in Seele:
...
### Step 2: Configure Azure OpenAI in Seele
...
Now you can engage in conversations using the models provided by Azure OpenAI in Seele.
