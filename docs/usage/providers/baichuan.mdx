---
title: Using Baichuan API Key in Seele
description: >-
  Learn how to integrate Baichuan AI into Seele for enhanced conversational
...
# Using Baichuan in Seele

<Image
  alt={'Using Baichuan in Seele'}
  cover
  src={'https://github.com/user-attachments/assets/d961f2af-47b0-4806-8288-b1e8f7ee8a47'}
/>

This article will guide you on how to use Baichuan in Seele:
...
### Step 2: Configure Baichuan in Seele
...
You can now use the models provided by Baichuan for conversation in Seele.
