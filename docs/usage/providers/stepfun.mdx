---
title: Using Stepfun API Key in Seele
description: >-
  Learn how to integrate Stepfun AI models into Seele for engaging
  conversations. Obtain Stepfun API key, configure Stepfun in Seele settings,
...
# Using Stepfun in Seele

<Image
  alt={'Using Stepfun in Seele'}
  cover
...
This document will guide you on how to use Stepfun in Seele:
...
### Step 2: Configure Stepfun in Seele
...
You can now use the models provided by Stepfun to have conversations in Seele.
