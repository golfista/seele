---
title: Using DeepSeek API Key in Seele
description: >-
  Learn how to use DeepSeek-V2 in Seele, obtain API keys. Get started with
...
# Using DeepSeek in Seele

<Image
  alt={'Using DeepSeek in Seele'}
  cover
...
This document will guide you on how to use DeepSeek in Seele:
...
### Step 2: Configure DeepSeek in Seele

- Access the `App Settings` interface in Seele.
...
You can now engage in conversations using the models provided by Deepseek in Seele.
