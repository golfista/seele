---
title: Using Minimax API Key in Seele
description: >-
  Learn how to use MiniMax in Seele to enhance AI conversations. Obtain
  MiniMax API key, configure MiniMax in Seele settings, and select a model
...
# Using Minimax in Seele

<Image
  alt={'Using Minimax in Seele'}
  cover
...
This document will guide you on how to use Minimax in Seele:
...
### Step 2: Configure MiniMax in Seele

- Go to the `Settings` interface of Seele
...
You can now use the models provided by MiniMax to have conversations in Seele.
