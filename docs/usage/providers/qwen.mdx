---
title: Using Qwen2 API Key in Seele
description: >-
  Learn how to integrate and utilize Tongyi Qianwen, a powerful language model
  by Alibaba Cloud, in Seele for various tasks. Follow the steps to activate
...
# Using Tongyi Qianwen in Seele

<Image
  alt={'Using Tongyi Qianwen in Seele'}
  cover
...
This document will guide you on how to use Tongyi Qianwen in Seele:
...
### Step 3: Configure Tongyi Qianwen in Seele
...
You can now engage in conversations using the models provided by Tongyi Qianwen in Seele.
