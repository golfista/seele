---
title: Using OpenAI API Key in Seele
description: >-
  Learn how to integrate OpenAI API Key in Seele. Support GPT-4o /
...
# Using OpenAI in Seele

<Image
  alt={'Using OpenAI in Seele'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'}
/>

This document will guide you on how to use [OpenAI](https://openai.com/) in Seele:
...
- Visit the `Settings` page in Seele
...
You can now engage in conversations using the models provided by OpenAI in Seele.
