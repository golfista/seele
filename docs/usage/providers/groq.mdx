---
title: Using Groq API Key in Seele
description: >-
  Learn how to obtain GroqCloud API keys and configure Groq in Seele for
  optimal performance.
tags:
...
This document will guide you on how to use Groq in Seele:
...
Next, select a Groq-supported model in the assistant's model options, and you can experience the powerful performance of Groq in Seele.
