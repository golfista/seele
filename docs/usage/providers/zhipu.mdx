---
title: Using Zhipu ChatGLM API Key in Seele
description: >-
  Learn how to integrate and utilize Zhipu AI models in Seele for enhanced
...
This document will guide you on how to use Zhipu AI in Seele:
...
You can now engage in conversations using the models provided by Zhipu AI in Seele.
