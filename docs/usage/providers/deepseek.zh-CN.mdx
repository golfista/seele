---
title: 在 Seele 中使用 DeepSeek API Key
description: 学习如何在 Seele 中配置和使用 DeepSeek 语言模型，获取 API 密钥并开始对话。
tags:
  - Seele
  - DeepSeek
  - API密钥
...
# 在 Seele 中使用 DeepSeek

<Image
  alt={'在 Seele 中使用 DeepSeek'}
  cover
...
至此你已经可以在 Seele 中使用 Deepseek 提供的模型进行对话了。
