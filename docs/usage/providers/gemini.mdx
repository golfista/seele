---
title: Using Google Gemini API Key in Seele
description: >-
  Learn how to integrate and utilize Google Gemini AI in Seele to enhance
...
# Using Google Gemini in Seele

<Image
  alt={'Using Google Gemini in Seele'}
  cover
...
This document will guide you on how to use Google Gemini in Seele:
...
Congratulations! You can now use Google Gemini in Seele.
