---
title: Using Amazon Bedrock API Key in Seele
description: >-
  Learn how to integrate Amazon Bedrock models into Seele for AI-powered
...
# Using Amazon Bedrock in Seele

<Image
  alt={'Using Amazon Bedrock in Seele'}
  cover
...
This document will guide you on how to use Amazon Bedrock in Seele:
...
You can now engage in conversations using the models provided by Amazon Bedrock in Seele.
