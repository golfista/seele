---
title: Seele support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies
  in Seele. Choose from a variety of high-quality voices for personalized
...
<Callout type={'info'}>
  During the implementation of the TTS feature in Seele, we found that there was no good frontend
