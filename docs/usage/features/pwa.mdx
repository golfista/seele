---
title: Seele support Progressive Web Apps (PWA)
description: >-
  Discover how Seele utilizes Progressive Web App (PWA) technology to provide
  a seamless and near-native app experience on both desktop and mobile devices.
  Learn how to install Seele as a desktop app for enhanced convenience.
tags:
  - Progressive Web App
  - PWA
  - Seele
...
<Callout type={'tip'}>
  The default installed Seele PWA icon has a black background, you can use <kbd>cmd</kbd> +  <kbd>i</kbd> to paste the following image to replace it with a white background.
</Callout>
