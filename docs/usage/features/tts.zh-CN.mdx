---
title: Seele 支持 TTS & STT 语音会话
description: Seele 支持文字转语音（TTS）和语音转文字（STT）技术，提供高品质声音选项，个性化交流体验。了解更多关于 Lobe TTS 工具包。
tags:
  - TTS
  - STT
  - 语音会话
...
Seele 支持文字转语音（Text-to-Speech，TTS）和语音转文字（Speech-to-Text，STT）技术，我们的应用能够将文本信息转化为清晰的语音输出，用户可以像与真人交谈一样与我们的对话代理进行交流。用户可以从多种声音中选择，给助手搭配合适的音源。 同时，对于那些倾向于听觉学习或者想要在忙碌中获取信息的用户来说，TTS 提供了一个极佳的解决方案。
...
<Callout type={'info'}>
  我们在实现 Seele 的 TTS 功能过程中，发现市面上并没有一款很好的 TTS
