---
title: Plugin System in Seele
description: >-
  Explore the diverse plugin ecosystem of Seele, extending its capabilities
...
- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for Seele. It retrieves the list of plugins from the index.json of this repository and displays them to the users.
...
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The Seele plugin SDK can help you create excellent Seele plugins.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The Seele plugin gateway is a backend service that serves as the gateway for Seele plugins. We deploy this service using Vercel.

### Roadmap Progress

The plugin system of Seele has now entered a stable stage, and we have basically completed most of the functionality required by the plugin system. However, we are still planning and considering the new possibilities that plugins can bring to us. You can learn more in the following Issues:
