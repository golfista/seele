---
title: Enhance Your Seele Assistant with Plugins
description: >-
  Learn how to expand your Seele assistant's capabilities by enabling and
...
The plugin system is a key element in expanding the capabilities of assistants in Seele. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using Seele plugins:
...
The Plugin Store allows you to directly install and use plugins within Seele.
