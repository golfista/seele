...
Upgrading the Docker deployment version is very simple, just redeploy the latest image of Seele. Here are the instructions to perform these steps:

1. Stop and delete the currently running Seele container (assuming the name of the Seele container is `lobe-chat`):
...
2. Pull the latest Docker image of Seele:

```fish
docker pull lobehub/lobe-chat
```

3. Redeploy the Seele container using the newly pulled image:
...
>
> Don't worry, all of Seele's chat history is stored in your local browser. Therefore, when you redeploy Seele using Docker, your chat history will not be lost.
